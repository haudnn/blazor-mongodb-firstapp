...
public class TodoData
{
    ...
    public async Task CreateTodoMigration(TodoModel todo)
    {
        ...
        if (todoList == null)
        {
            todoList = new TodoListModel { date = currentDate };
        ...
        // var filter = Builders<Todo>.Filter.Eq("_id", newTodo.Id);
        // var update = Builders<Todo>.Update.Set("TodoListId", todolist.Id);
        // todoCollection.UpdateOne(filter, update);
